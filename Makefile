...
noinst_PROGRAMS = test1$(EXEEXT) test2$(EXEEXT) tdict$(EXEEXT)
am__append_1 = -Wl,--version-script=$(top_srcdir)/libpopt.vers
subdir = .
DIST_COMMON = README $(am__configure_deps) $(include_HEADERS) \
	$(noinst_HEADERS) $(srcdir)/Doxyfile.in $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/popt.pc.in $(srcdir)/popt.spec.in \
	$(srcdir)/test-poptrc.in $(top_srcdir)/configure ABOUT-NLS \
	COPYING config.guess config.rpath config.sub depcomp \
...
CONFIG_CLEAN_FILES = Doxyfile popt.pc popt.spec test-poptrc
...
am_tdict_OBJECTS = tdict.$(OBJEXT)
tdict_OBJECTS = $(am_tdict_OBJECTS)
tdict_DEPENDENCIES = $(usrlib_LTLIBRARIES)
tdict_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	--mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) $(tdict_LDFLAGS) \
	$(LDFLAGS) -o $@
...
LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	...
	$(LDFLAGS) -o $@
SOURCES = $(libpopt_la_SOURCES) $(tdict_SOURCES) $(test1_SOURCES) \
	$(test2_SOURCES)
DIST_SOURCES = $(libpopt_la_SOURCES) $(tdict_SOURCES) $(test1_SOURCES) \
	$(test2_SOURCES)
...
ACLOCAL = ${SHELL} /home/ztf/Downloads/popt-1.16/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/ztf/Downloads/popt-1.16/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/ztf/Downloads/popt-1.16/missing --run autoconf
AUTOHEADER = ${SHELL} /home/ztf/Downloads/popt-1.16/missing --run autoheader
AUTOMAKE = ${SHELL} /home/ztf/Downloads/popt-1.16/missing --run automake-1.11
AWK = mawk
CC = gcc
...
LT_REVISION = 0
MAINT = #
MAKEINFO = ${SHELL} /home/ztf/Downloads/popt-1.16/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
POPT_SOURCE_PATH = /home/ztf/Downloads/popt-1.16
POSUB = po
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
...
abs_builddir = /home/ztf/Downloads/popt-1.16
abs_srcdir = /home/ztf/Downloads/popt-1.16
abs_top_builddir = /home/ztf/Downloads/popt-1.16
abs_top_srcdir = /home/ztf/Downloads/popt-1.16
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/ztf/Downloads/popt-1.16/install-sh
...
popt.spec: $(top_builddir)/config.status $(srcdir)/popt.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
test-poptrc: $(top_builddir)/config.status $(srcdir)/test-poptrc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
installdirs-am:
	for dir in "$(DESTDIR)$(usrlibdir)" "$(DESTDIR)$(man3dir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(includedir)"; do \
...
install-data-am: install-includeHEADERS install-man \
	install-pkgconfigDATA install-usrlibLTLIBRARIES
...
uninstall-am: uninstall-includeHEADERS uninstall-man \
	uninstall-pkgconfigDATA uninstall-usrlibLTLIBRARIES
